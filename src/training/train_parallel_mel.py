...
def main():
    ...
    print("\n=== Parallel CNN v2 + Mel-Spectrogram ===")

    # 🔥 ONLY CHANGE IS HERE
    X = np.load(os.path.join(data_dir, "mel_spectrogram.npy"))
    ...
    save_path = os.path.join(save_dir, "parallelcnn_mel_v2.pth")
