"""
train_rawmel.py
Raw wav-аас гаргасан mel features дээр ResNet2D+SE сургана.
Гаднаас ирсэн wav файл дээр ажиллах зорилготой.
"""
...
SAVE_PATH  = os.path.join(MODEL_DIR, "resnet_rawmel_v1.pth")
STATS_PATH = os.path.join(MODEL_DIR, "resnet_rawmel_v1_stats.npz")
...
# ── DATA ─────────────────────────────────────────────────────────
print("\nДата ачаалж байна...")
mel = np.load(os.path.join(DATA_DIR, "rawmel_features.npy"))
y   = np.load(os.path.join(DATA_DIR, "rawmel_labels.npy"))
...
# Norm stats хадгалах — app.py-д хэрэгтэй
